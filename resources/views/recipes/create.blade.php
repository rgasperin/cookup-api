...
@section('content')
    <section class="padding-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="text-center">Criar Nova Receita</h1>
                    <hr>
                    @if (!empty($types) && !empty($ingredients))
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-6">
                                    ...
                                    <input class="form-control form-control-bg" type="text" name="ingredients_default"
                                        id="ingredients_default" placeholder="Ingredientes da receita" required>
                                </div>
                                <div class="col-lg-6" id="ingredients-wrapper">
                                    ...
                                    <button class="btn btn-secondary mt-2" type="button"
                                        onclick="addIngredient()">Adicionar
                                        Ingredientes</button>
                                </div>
                            </div>
                            <div class="row mt-4">
