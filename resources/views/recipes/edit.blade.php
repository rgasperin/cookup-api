...
<section class="padding-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="text-center">Editar Receita</h1> <hr>
                ...
                <form action="{{ url('receitas/' . $recipe['id']) }}" method="POST" >
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control form-control-bg" type="text" name="name" id="name" value="{{ $recipe['receita'] }}" placeholder="Nome da receita" required>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            ...
                            <input class="form-control form-control-bg" type="text" name="ingredients_default" id="ingredients_default" value="{{ $recipe['ingredientes'] }}" placeholder="Ingredientes da receita" required>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control textarea-height" id="mode_preparation" name="mode_preparation" placeholder="Mensagem..."  required>{{ $recipe['modo_preparo'] }}</textarea>
                        </div>
                    </div>
