        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a class="d-flex text-decoration-none text-style" href="{{ url('tipos/criar') }}">
                        <i class="fi fi-rr-add icon-style me-1"></i> Adicionar Tipos
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="slider">
                        @foreach ($ingredients as $ingredient)
                            <div class="card card-style me-1 ms-1">
                                ...
                                <span class="sub-text">Data de Validade: <b
                                        class="ms-1">{{ $ingredient['data_de_validade'] }}</b></span>
                            </div>
                        @endforeach
                    </div>
                @else
